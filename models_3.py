...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3_bn = nn.BatchNorm2d(2*t)
        
        self.conv4 = nn.Conv2d(2*t, 4*t, 2)
        # pooling
        ...
        self.conv5_bn = nn.BatchNorm2d(8*t)       
        
        self.conv6 = nn.Conv2d(8*t, 16*t, 2)
        # pooling
        # output tensor: (16t, 2, 2) 
        self.conv6_bn = nn.BatchNorm2d(16*t) 
        
        self.pool = nn.MaxPool2d(2, 2)
        
        cv_out = t*2*2

        self.fc1 = nn.Linear(16*cv_out, 8*cv_out)
        self.fc2 = nn.Linear(8*cv_out, 4*cv_out)
        self.fc3 = nn.Linear(4*cv_out, 2*cv_out)
        self.fc4 = nn.Linear(2*cv_out, cv_out)
        self.fc5 = nn.Linear(cv_out, 136)
